...
def extractWindow(tss_start, tss_stop, motif, dist_end, struct_ener_map):
    ...
    temp = params_arr.pop(0)
    params_arr.append(temp)
    # print(params_arr)
    # import sys
    # sys.exit()
    return params_arr
...
def iterate(seq, parameters_map):
    ...
    params = list(struct_ener_map.keys())
    # print(params)
    length = len(struct_ener_map[params[0]])
    # print(length)
    # import sys
    # sys.exit()
    i=0
    ...
    # import sys
    # sys.exit()
    return predictPCA(seq,motif_map)
...
def processResults(seq,motif_map):
    ...
    for start in combined_result_map.keys():
        tss = 0
        no_tss = 0
        result = []
        for row in combined_result_map[start].keys():
